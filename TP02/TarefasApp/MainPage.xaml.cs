...
public partial class MainPage : ContentPage
{
    ...
    {
        new Models.Task(1, "Tarefa 1", "Descrição Tarefa 1", DateTime.Now, 1),
        new Models.Task(2, "Tarefa 2", "DDescrição Tarefa 2", DateTime.Now, 2),
        new Models.Task(3, "Tarefa 3", "Descrição Tarefa 3", DateTime.Now, 3)
    };
